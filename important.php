        ...
        <section class="info-list" aria-labelledby="guidelines">
            <div class="info-box" id="notice">
                <div class="icon" aria-hidden="true">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 7a1 1 0 0 1 1-1h16a1 1 0 0 1 1 1v3a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V7z" stroke="#111" stroke-width="1.1" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
                <div>
                    <p><strong>Your vote is anonymous and will be recorded securely.</strong> Once submitted, it cannot be changed.</p>
                </div>
            </div>

            <div class="info-box" id="guidelines" role="region" aria-labelledby="guidelines-heading">
                <div class="icon" aria-hidden="true">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9 12l2 2 4-5" stroke="#111" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
                <div>
            ...
            <div class="info-box" id="responsibilities" role="region" aria-labelledby="resp-heading">
                <div class="icon" aria-hidden="true">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" stroke="#111" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/><path d="M3 21v-1a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4v1" stroke="#111" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
                <div>
            ...
            <div class="info-box" id="privacy" role="region" aria-labelledby="privacy-heading">
                <div class="icon" aria-hidden="true">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 3c-3 0-6 1.5-6 6v3c0 4.5 3 7 6 8 3-1 6-3.5 6-8V9c0-4.5-3-6-6-6z" stroke="#111" stroke-width="1.1" stroke-linecap="round" stroke-linejoin="round"/></svg>
                </div>
                <div>
