    ...
    <form method="POST">
        <section class="cards">
            <div class="card" onclick="selectCard(this)">
                <img src="images/sarah.jpeg.jpg" alt="Sarah Johnson, Vice Presidential Candidate for Progressive Alliance, professional headshot with confident expression">
                <div>
                    <h2>Sarah Johnson</h2>
            ...
            <div class="card" onclick="selectCard(this)">
                <img src="images/michael.jpeg.jpg" alt="Michael Chien, Vice Presidential Candidate for Unit Party, professional headshot with thoughtful expression">
                <div>
                    <h2>Michael Chien</h2>
                    <h3>Unit Party</h3>
            ...
            <div class="card" onclick="selectCard(this)">
                <img src="images/emily.jpeg.jpg" alt="Emily Rodriguez, Vice Presidential Candidate for Democratic Front, professional headshot with warm and approachable expression">
                <div>
